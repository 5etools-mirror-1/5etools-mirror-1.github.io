...
class OptionalFeaturesSublistManager extends SublistManager {
	...
	pGetSublistItem (it, hash) {
		const prerequisite = Renderer.utils.getPrerequisiteHtml(it.prerequisite, {isListMode: true, disallowlistKeys: new Set(["level"])});
...
class OptionalFeaturesPage extends ListPage {
	...
	getListItem (it, ivI, isExcluded) {
		...
		eleLi.className = `lst__row ve-flex-col ${isExcluded ? "lst__row--disallowlisted" : ""}`;
